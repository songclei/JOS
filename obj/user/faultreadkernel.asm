	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ef:	0f be 80 51 1f 80 00 	movsbl 0x801f51(%eax),%eax
  8001f6:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8002eb:	ff 24 85 a0 20 80 00 	jmp    *0x8020a0(,%eax,4)
  ...
  800463:	8b 14 85 00 22 80 00 	mov    0x802200(,%eax,4),%edx
  80046a:	85 d2                	test   %edx,%edx
  80046c:	75 18                	jne    800486 <vprintfmt+0x20e>
				printfmt(putch, putdat, "error %d", err);
  80046e:	50                   	push   %eax
  80046f:	68 69 1f 80 00       	push   $0x801f69
  800474:	53                   	push   %ebx
  800475:	56                   	push   %esi
  ...
  800486:	52                   	push   %edx
  800487:	68 31 23 80 00       	push   $0x802331
  80048c:	53                   	push   %ebx
  80048d:	56                   	push   %esi
  ...
  8004ab:	b8 62 1f 80 00       	mov    $0x801f62,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b98:	68 5f 22 80 00       	push   $0x80225f
  800b9d:	6a 23                	push   $0x23
  800b9f:	68 7c 22 80 00       	push   $0x80227c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c19:	68 5f 22 80 00       	push   $0x80225f
  800c1e:	6a 23                	push   $0x23
  800c20:	68 7c 22 80 00       	push   $0x80227c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c5b:	68 5f 22 80 00       	push   $0x80225f
  800c60:	6a 23                	push   $0x23
  800c62:	68 7c 22 80 00       	push   $0x80227c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c9d:	68 5f 22 80 00       	push   $0x80225f
  800ca2:	6a 23                	push   $0x23
  800ca4:	68 7c 22 80 00       	push   $0x80227c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cdf:	68 5f 22 80 00       	push   $0x80225f
  800ce4:	6a 23                	push   $0x23
  800ce6:	68 7c 22 80 00       	push   $0x80227c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d21:	68 5f 22 80 00       	push   $0x80225f
  800d26:	6a 23                	push   $0x23
  800d28:	68 7c 22 80 00       	push   $0x80227c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d63:	68 5f 22 80 00       	push   $0x80225f
  800d68:	6a 23                	push   $0x23
  800d6a:	68 7c 22 80 00       	push   $0x80227c
...
sys_ipc_recv(void *dstva)
{
  ...
  800dc7:	68 5f 22 80 00       	push   $0x80225f
  800dcc:	6a 23                	push   $0x23
  800dce:	68 7c 22 80 00       	push   $0x80227c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800eb5:	ba 08 23 80 00       	mov    $0x802308,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800ee0:	51                   	push   %ecx
  800ee1:	50                   	push   %eax
  800ee2:	68 8c 22 80 00       	push   $0x80228c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80110a:	53                   	push   %ebx
  80110b:	50                   	push   %eax
  80110c:	68 cd 22 80 00       	push   $0x8022cd
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8011df:	53                   	push   %ebx
  8011e0:	50                   	push   %eax
  8011e1:	68 e9 22 80 00       	push   $0x8022e9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801294:	53                   	push   %ebx
  801295:	50                   	push   %eax
  801296:	68 ac 22 80 00       	push   $0x8022ac
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  8014d4:	68 1f 23 80 00       	push   $0x80231f
  8014d9:	68 9f 00 00 00       	push   $0x9f
  8014de:	68 34 23 80 00       	push   $0x802334
  ...
  8014ef:	68 4c 23 80 00       	push   $0x80234c
  8014f4:	68 1f 23 80 00       	push   $0x80231f
  8014f9:	68 a0 00 00 00       	push   $0xa0
  8014fe:	68 34 23 80 00       	push   $0x802334
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  80153f:	68 18 23 80 00       	push   $0x802318
  801544:	68 1f 23 80 00       	push   $0x80231f
  801549:	6a 7e                	push   $0x7e
  80154b:	68 34 23 80 00       	push   $0x802334
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80164b:	68 79 23 80 00       	push   $0x802379
  801650:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8016fb:	50                   	push   %eax
  8016fc:	56                   	push   %esi
  8016fd:	68 80 23 80 00       	push   $0x802380
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80199f:	68 98 23 80 00       	push   $0x802398
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801b2e:	56                   	push   %esi
  801b2f:	50                   	push   %eax
  801b30:	68 a4 23 80 00       	push   $0x8023a4
  ...
  801b41:	e8 aa e5 ff ff       	call   8000f0 <vcprintf>
	cprintf("\n");
  801b46:	c7 04 24 91 23 80 00 	movl   $0x802391,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801be7:	68 c8 23 80 00       	push   $0x8023c8
  801bec:	6a 44                	push   $0x44
  801bee:	68 f4 23 80 00       	push   $0x8023f4
