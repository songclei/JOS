...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  800039:	c7 05 00 30 80 00 20 	movl   $0x801f20,0x803000
  800040:	1f 80 00 
...
sys_env_destroy(envid_t envid)
{
  ...
  80010f:	68 2f 1f 80 00       	push   $0x801f2f
  800114:	6a 23                	push   $0x23
  800116:	68 4c 1f 80 00       	push   $0x801f4c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800190:	68 2f 1f 80 00       	push   $0x801f2f
  800195:	6a 23                	push   $0x23
  800197:	68 4c 1f 80 00       	push   $0x801f4c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001d2:	68 2f 1f 80 00       	push   $0x801f2f
  8001d7:	6a 23                	push   $0x23
  8001d9:	68 4c 1f 80 00       	push   $0x801f4c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800214:	68 2f 1f 80 00       	push   $0x801f2f
  800219:	6a 23                	push   $0x23
  80021b:	68 4c 1f 80 00       	push   $0x801f4c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800256:	68 2f 1f 80 00       	push   $0x801f2f
  80025b:	6a 23                	push   $0x23
  80025d:	68 4c 1f 80 00       	push   $0x801f4c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800298:	68 2f 1f 80 00       	push   $0x801f2f
  80029d:	6a 23                	push   $0x23
  80029f:	68 4c 1f 80 00       	push   $0x801f4c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002da:	68 2f 1f 80 00       	push   $0x801f2f
  8002df:	6a 23                	push   $0x23
  8002e1:	68 4c 1f 80 00       	push   $0x801f4c
...
sys_ipc_recv(void *dstva)
{
  ...
  80033e:	68 2f 1f 80 00       	push   $0x801f2f
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80042c:	ba d8 1f 80 00       	mov    $0x801fd8,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800457:	51                   	push   %ecx
  800458:	50                   	push   %eax
  800459:	68 5c 1f 80 00       	push   $0x801f5c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800681:	53                   	push   %ebx
  800682:	50                   	push   %eax
  800683:	68 9d 1f 80 00       	push   $0x801f9d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800756:	53                   	push   %ebx
  800757:	50                   	push   %eax
  800758:	68 b9 1f 80 00       	push   $0x801fb9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80080b:	53                   	push   %ebx
  80080c:	50                   	push   %eax
  80080d:	68 7c 1f 80 00       	push   $0x801f7c
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  800a46:	68 e8 1f 80 00       	push   $0x801fe8
  800a4b:	68 ef 1f 80 00       	push   $0x801fef
  800a50:	68 9f 00 00 00       	push   $0x9f
  800a55:	68 04 20 80 00       	push   $0x802004
  ...
  800a66:	68 1c 20 80 00       	push   $0x80201c
  800a6b:	68 ef 1f 80 00       	push   $0x801fef
  800a70:	68 a0 00 00 00       	push   $0xa0
  800a75:	68 04 20 80 00       	push   $0x802004
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800ab6:	68 e8 1f 80 00       	push   $0x801fe8
  800abb:	68 ef 1f 80 00       	push   $0x801fef
  800ac0:	6a 7e                	push   $0x7e
  800ac2:	68 04 20 80 00       	push   $0x802004
  800ac7:	e8 bd 05 00 00       	call   801089 <_panic>
	assert(r <= PGSIZE);
  800acc:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800ad1:	7e 16                	jle    800ae9 <devfile_read+0x65>
  800ad3:	68 0f 20 80 00       	push   $0x80200f
  800ad8:	68 ef 1f 80 00       	push   $0x801fef
  800add:	6a 7f                	push   $0x7f
  800adf:	68 04 20 80 00       	push   $0x802004
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800bc2:	68 49 20 80 00       	push   $0x802049
  800bc7:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800c72:	50                   	push   %eax
  800c73:	56                   	push   %esi
  800c74:	68 50 20 80 00       	push   $0x802050
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800f16:	68 68 20 80 00       	push   $0x802068
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8010a5:	56                   	push   %esi
  8010a6:	50                   	push   %eax
  8010a7:	68 74 20 80 00       	push   $0x802074
  ...
  8010b8:	e8 54 00 00 00       	call   801111 <vcprintf>
	cprintf("\n");
  8010bd:	c7 04 24 61 20 80 00 	movl   $0x802061,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801210:	0f be 80 97 20 80 00 	movsbl 0x802097(%eax),%eax
  801217:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80148f:	50                   	push   %eax
  801490:	68 af 20 80 00       	push   $0x8020af
  801495:	53                   	push   %ebx
  801496:	56                   	push   %esi
  ...
  8014a7:	52                   	push   %edx
  8014a8:	68 01 20 80 00       	push   $0x802001
  8014ad:	53                   	push   %ebx
  8014ae:	56                   	push   %esi
  ...
  8014cc:	b8 a8 20 80 00       	mov    $0x8020a8,%eax
