...
umain(int argc, char **argv)
{
  ...
  800067:	50                   	push   %eax
  800068:	68 24 25 80 00       	push   $0x802524
  80006d:	6a 09                	push   $0x9
  80006f:	68 3c 25 80 00       	push   $0x80253c
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8000f7:	56                   	push   %esi
  8000f8:	50                   	push   %eax
  8000f9:	68 58 25 80 00       	push   $0x802558
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800262:	0f be 80 7b 25 80 00 	movsbl 0x80257b(%eax),%eax
  800269:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8004e1:	50                   	push   %eax
  8004e2:	68 93 25 80 00       	push   $0x802593
  8004e7:	53                   	push   %ebx
  8004e8:	56                   	push   %esi
  ...
  80051e:	b8 8c 25 80 00       	mov    $0x80258c,%eax
